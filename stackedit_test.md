...
Summary of [this](https://arxiv.org/pdf/1610.03013.pdf) paper by Kees ter Brugge
...
![asdfasd](https://avatars0.githubusercontent.com/u/348682?v=3&s=32)


https://drive.google.com/open?id=0B2XZIOjBTwEfVzd0OTBxdUxXOWs
...
note over user,metamarkets:a: a month later


mopub->adgoji: Per month, per campaign cost
...
Feedback is very welcome,
    especially for clarification of the used terms, 
    additional sent messages,
    additional fields of messages,
    additional message senders/receivers
    when and which db's store which messages,
    etc.
    
## Question that I would still like to answer in this diagram:
